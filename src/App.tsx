  ...
  return (
    <div className="app">
      ...
      <header className={`header${scrolled ? ' header--scrolled' : ''}`}>
        <div className="container">
          ...
          <nav className="nav">
            ...
            <button className="btn btn-primary">Book a Call <ChevronRight size={16} /></button>
          </nav>
        </div>
      </header>
      ...
      <main>
        ...
        <section id="results" className="testimonials">
          <div className="container">
            <div className="section-header">
              <div className="section-badge">
                <Star size={14} />
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-links-group">
              ...
              <a href="#services">Agent Systems</a>
              <a href="#services">Blueprints</a>
